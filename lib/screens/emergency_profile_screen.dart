...
class _EmergencyProfileScreenState extends State<EmergencyProfileScreen> {
  // Sample data - in real app, this would be loaded from storage
  String patientName = 'Juan Dela Cruz';
  String dateOfBirth = 'January 15, 1975';
  String bloodType = 'O+';
  String allergies = 'Penicillin, Shellfish';
  List<String> conditions = ['Type 2 Diabetes', 'Hypertension'];
  List<String> medications = ['Metformin 500mg', 'Lisinopril 10mg'];
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionCard(
              ...
              primary,
              [
                _buildInfoRow('Full Name', patientName),
            ...
            _buildSectionCard(
              ...
              medications
                  .map((medication) => _buildBulletPoint(medication))
                  .toList(),
            ),
